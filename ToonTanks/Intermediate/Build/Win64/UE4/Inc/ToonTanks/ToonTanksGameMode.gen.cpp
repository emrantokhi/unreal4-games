...
// End Cross Module References
	static FName NAME_AToonTanksGameMode_DisplayHUD = FName(TEXT("DisplayHUD"));
	void AToonTanksGameMode::DisplayHUD(float Health, float MaxHealth, int32 NumTowers)
	{
		ToonTanksGameMode_eventDisplayHUD_Parms Parms;
		Parms.Health=Health;
		Parms.MaxHealth=MaxHealth;
		Parms.NumTowers=NumTowers;
		ProcessEvent(FindFunctionChecked(NAME_AToonTanksGameMode_DisplayHUD),&Parms);
	}
	...
	struct Z_Construct_UFunction_AToonTanksGameMode_DisplayHUD_Statics
	{
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_Health;
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_MaxHealth;
		static const UE4CodeGen_Private::FIntPropertyParams NewProp_NumTowers;
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_AToonTanksGameMode_DisplayHUD_Statics::NewProp_Health = { "Health", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ToonTanksGameMode_eventDisplayHUD_Parms, Health), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_AToonTanksGameMode_DisplayHUD_Statics::NewProp_MaxHealth = { "MaxHealth", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ToonTanksGameMode_eventDisplayHUD_Parms, MaxHealth), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AToonTanksGameMode_DisplayHUD_Statics::NewProp_NumTowers = { "NumTowers", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ToonTanksGameMode_eventDisplayHUD_Parms, NumTowers), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AToonTanksGameMode_DisplayHUD_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AToonTanksGameMode_DisplayHUD_Statics::NewProp_Health,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AToonTanksGameMode_DisplayHUD_Statics::NewProp_MaxHealth,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AToonTanksGameMode_DisplayHUD_Statics::NewProp_NumTowers,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AToonTanksGameMode_DisplayHUD_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "ToonTanksGameMode.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AToonTanksGameMode_DisplayHUD_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AToonTanksGameMode, nullptr, "DisplayHUD", nullptr, nullptr, sizeof(ToonTanksGameMode_eventDisplayHUD_Parms), Z_Construct_UFunction_AToonTanksGameMode_DisplayHUD_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AToonTanksGameMode_DisplayHUD_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08080800, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AToonTanksGameMode_DisplayHUD_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AToonTanksGameMode_DisplayHUD_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AToonTanksGameMode_DisplayHUD()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AToonTanksGameMode_DisplayHUD_Statics::FuncParams);
		}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AToonTanksGameMode_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AToonTanksGameMode_DisplayHUD, "DisplayHUD" }, // 3253265398
	...
	IMPLEMENT_CLASS(AToonTanksGameMode, 3142758509);
